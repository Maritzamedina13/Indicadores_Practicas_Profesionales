...
.hist-chart-label {
  font-size:.72rem; font-weight:700; color:var(--itm-blue);
  text-transform:uppercase; letter-spacing:.05em;
  margin-bottom:8px; padding:4px 10px;
  background:#eef2ff; border-left:3px solid var(--itm-blue);
...
<section id="sec-historicos" class="section">
  ...
  <div class="charts-grid">
    ...
    <div class="card full">
      ...
      <div class="card-body">
        <div class="rg-hist-1-2" style="display:grid;grid-template-columns:1fr 2fr;gap:24px;align-items:center">
          <div>
            <div class="hist-chart-label">📅 Total por Año</div>
            <div class="ch h260"><canvas id="c-hist-pre-anio"></canvas></div>
          </div>
          <div>
            <div class="hist-chart-label">📈 Evolución por Trimestre</div>
    ...
    <div class="card full">
      ...
      <div class="card-body">
        <div class="hist-chart-label">📊 Comparativo 2024 · 2025 · 2026* por indicador</div>
